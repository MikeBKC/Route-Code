...
/*  *******************___DEFINE___*******************  */
#define WTP_LOG_FILE_NAME	"/var/log/wtp.log"
...
#ifdef URCP_IPC
extern CWThreadMutex        urcpMutex;
#endif
...
#ifdef URCP_IPC
extern CW_THREAD_RETURN_TYPE CWWTPUrcp(void *arg);
extern CWBool CWWTPParseUrcpPDURequest(char *buff, int len);
extern CWBool CWWTPAssembleUrcpPDUResponse(CWProtocolMessage **messagesPtr,
	int *fragmentsNumPtr,
	int PMTU,
	int seqNum,
