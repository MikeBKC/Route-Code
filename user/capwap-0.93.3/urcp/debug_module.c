...
#ifdef FEATURE_AC
	{URCP_MODULE_ID_STA_LOG,   "log",   URCP_DB_MIN, URCP_LOG_MIN},
#endif
	{URCP_MODULE_ID_TRAP_STA,   "trapSta",   URCP_DB_MIN, URCP_LOG_MIN},
	{URCP_MODULE_ID_USER_LIST,   "userList",   URCP_DB_MIN, URCP_LOG_MIN},
	{URCP_MODULE_ID_APP,   "app",   URCP_DB_MIN, URCP_LOG_MIN},
	{URCP_MODULE_ID_HOST_NAME,   "staName",   URCP_DB_MIN, URCP_LOG_MIN},
#ifdef FEATURE_AP
	{URCP_MODULE_ID_STATE,   "state",   URCP_DB_MIN, URCP_LOG_MIN},
#endif
	{URCP_MODULE_ID_TFTP,   "tftp",   URCP_DB_MIN, URCP_LOG_MIN},
