...
#define TFTP_BLOCK_LEN            1368u 
/*最大超时时间*/
#if 1//def URCP_AP
#define TFTP_TIMEOUT_MS        (1500u/POLL_TIME) /*(6400u/POLL_TIME)*/
#else
#define TFTP_TIMEOUT_MS           (4000u/POLL_TIME)
#endif
/*重发超时时间*/
#if 1//def URCP_AP
#define TFTP_MAX_TIMEOUT_MS         (6000u/POLL_TIME)  /*(8000u/POLL_TIME)*/
#else
...
#else
#define MAX_URCP_TFTP_SESSION     128u
#endif
...
extern void urcp_tftp_session_clear_by_id(uint32 id);
#endif
