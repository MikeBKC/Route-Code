...
#define		CW_MSG_TYPE_VALUE_URCP_REQUEST                          101
#define		CW_MSG_TYPE_VALUE_URCP_RESPONSE		                102
...
#endif
#define 	CW_MSG_ELEMENT_URCP_PDU_CW_TYPE			        200
...
typedef struct {
	...
	enum {
		...
		CW_BOARD_ID		= 2,
		CW_BOARD_REVISION	= 3,
	        CW_BASE_MAC_ADDRERSS    = 4, 
		CW_WTP_MODEL_NAME	= 5, /*ÐÍºÅÃû*/
...
CWBool CWAssembleUrcpMessage(CWProtocolMessage **completeMsgPtr, int *fragmentsNumPtr, int PMTU, int seqNum, int msgTypeValue, CWProtocolMessage *msgElems, const int msgElemNum, CWProtocolMessage *msgElemsBinding, const int msgElemBindingNum, int is_crypted);
