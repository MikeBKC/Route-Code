...
conf_file=$vend_id\_$prod_id\_modeswitch.conf
else
...
#加载模块
if [ "$vend_id" = "12d1" -a "$prod_id" = "1446" ] || [ "$vend_id" = "12d1" -a "$prod_id" = "1001" ]; then
#	insmod /lib/modules/2.6.36/kernel/fs/fat/fat.ko
#	insmod /lib/modules/2.6.36/kernel/fs/vfat/vfat.ko
#	insmod /lib/modules/2.6.36/kernel/fs/isofs/isofs.ko
...
if [ "$vend_id" = "19d2" -a "$prod_id" = "2000" ]; then
	usb_modeswitch -W -c /etc_ro/usb/$conf_file
else
