...
void cwmp_conf_init(cwmp_t * cwmp)
{
    ...
    cwmp->stun_auth =  cwmp_conf_get_int("cwmp:stun_auth");
	...
	if(cwmp->stun_auth)
	{
	    cwmp->stun_user = cwmp_conf_pool_get(pool, "cwmp:stun_username");
        cwmp->stun_pwd  = cwmp_conf_pool_get(pool, "cwmp:stun_password");
	}

    cwmp->acs_period  =  cwmp_conf_get_int("cwmp:acs_period");
    cwmp->stun_period =  cwmp_conf_get_int("cwmp:stun_period");
    ...
    cwmp->stun_url    =   cwmp_conf_pool_get(pool, "cwmp:stun_url"); //      77.72.174.161:3478
