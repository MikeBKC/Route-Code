 ...
 *
 * $Id: webs.h,v 1.5 2014/02/14 13:39:58 zhao.chong Exp $
 */
...
#define WEBS_BUFSIZE			1400		/* websWrite max output string */
...
#define CGI_FIRMWARE_UPLOAD		T("upgrade.cgi")
...
extern char_t *websGetVarNull(webs_t wp, char_t *var, char_t *defaultGetValue, char_t *nullValue);
...
extern int 		 websWriteBigBlock(webs_t wp, char_t* fmt, ...);
