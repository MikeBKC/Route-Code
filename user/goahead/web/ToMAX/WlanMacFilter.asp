...
function save(){
	MacFilterGloable_Config.action="/goform/ConfigWlanMacFilterGlobalConfig";
...
function EditConfig(val,i){
	...
	WlanMacFilter_List.action="WlanMacFilter_edit.asp";
	WlanMacFilter_List.submit();
}
function DeleteConfig(index){
	if(confirm("<% write(SureDel); %>")){
		WlanMacFilter_List.delstr.value=filterMacs[index];
		WlanMacFilter_List.action="/goform/ConfigWlanMacFilterDel";
	    WlanMacFilter_List.submit();
...
function delAll(){
	if(confirm("<% write(SureDelAll); %>")){
		WlanMacFilter_List.action="/goform/ConfigWlanMacFilterDelAll";
		WlanMacFilter_List.submit();
	}
}
//-->
...
<form name="WlanMacFilter_List" method="post" action="/goform/ConfigWlanMacFilterDel">
   <table id=grouplist style="display"  border="0" align="center" cellpadding="0" cellspacing="0">
		    ...
		    <tr>
		      <td colspan="4">
			<iframe src="_list1.htm" name="frame12"	id="framelist" align="MIDDLE" width="920" height="260" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe></td>
		    </tr>
		    <tr>
