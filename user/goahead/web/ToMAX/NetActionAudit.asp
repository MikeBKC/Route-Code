...
var strSecondMenuFocus="<% write(UBAS); %>";
...
function updateLog()
{
	makeRequest("/goform/syslog_audit", "n/a", false);
}
...
function delLogInformation()
{
    ...
    {
	NetAction_Config.action = "/goform/DelHistoryLog";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <td width="15"></td>
  <!--////内容-->
  <td><script language="javascript">showSecondTitle("<% write(NetUBSA); %>");</script>
...
<p>&nbsp;</p>
	<script language="javascript">
		var arrayThreeMenu=new Array(
						"95%",
						2,
						new Array("<% write(UBAS); %>",'NetActionAudit.asp',1,1),
						new Array("<% write(LogManage); %>",'LogManage.asp',1,0)
		);
		showThreeMenu();
	</script>
