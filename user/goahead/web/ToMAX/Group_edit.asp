...
<td id="yutd3"></td>
	   ...
	   <td width="2%">&nbsp;</td>
	   <td><input type="text" name="uMaxDownRatetxt" onKeyPress="figureOnly()" onBlur="changeSelect(this,Group_Config.uMaxDownRatew)" size="8" maxlength="6">&nbsp;kbit/s&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:12px">&lt;==</b>&nbsp;<select name="uMaxDownRatew" class="list" onChange="changeRate(this,Group_Config.uMaxDownRatetxt)">
	  <option value="0"><%write(com_noLimit);%></option>
	   ...
	   <td width="2%">&nbsp;</td>
	   <td><input type="text" name="MaxDownRatetxt" onKeyPress="figureOnly()" onBlur="changeSelect(this,Group_Config.MaxDownRatew)" size="8" maxlength="6">&nbsp;kbit/s&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:12px">&lt;==</b>&nbsp;<select name="MaxDownRatew" class="list" onChange="changeRate(this,Group_Config.MaxDownRatetxt)">
	  <option value="0"><%write(com_noLimit);%></option>
	   <option value="zidingyi"><%write(com_defSelf);%></option>
		<script language="javascript">
		for(i=0;i<RateArr.length;i++)
