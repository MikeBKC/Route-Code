...
{
    var f= FtpServerGloable_Config;
    if((f.ftpPort.value < 1) || (f.ftpPort.value > 65535))
    {
	alert("FTP端口应为1到65535之间的数字")
	    return false;
    }
    return true;
}
                            	...
                            	<form action="" onSubmit="return " name="FtpServerGloable_Config" method="post">
                                    ...
                                    <tr>
									 ...
									 <tr>
                                      ...
                                      <td height="25">&nbsp;</td>
                                      <td align="left"  height="25" valign="middle"><input type="text" name="ftpPort" class="input" size="5" value="21"><% write(ftpPrompt); %></td>
                                    </tr>
                                    <!--
                                     <tr>
...
<form name="WlanMacFilter_List" method="post" action="/goform/formFtpServerDirDel">
   <table id=grouplist style="display"  border="0" align="center" cellpadding="0" cellspacing="0">
		    ...
		    <tr>
		      <td colspan="4">
			<iframe src="_list1.htm" name="frame12"	id="framelist"  scrolling="no" align="MIDDLE" width="920" height="250" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe></td>
		    </tr>
		    <tr>
