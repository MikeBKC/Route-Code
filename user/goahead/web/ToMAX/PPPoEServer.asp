...
{
	if(index==0) dspList(index,list,920,titles1,11,arrayData1,1,1);
}
/******************list***********************/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr valign="top">
   ...
   <table id=grouplist style="display" width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" height="490">
  <tr>
    <td align="center" class="three_td" valign="top"><table id=grouplist style="display" width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
	<tr><td colspan="4" height="40">&nbsp;</td></tr>
		    <tr>
		      <td colspan="4" align="center"><iframe src="_listhead1.htm" name="frame11"  align="MIDDLE" width="920" height="45" scrolling="no" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden ></iframe></td>
		    </tr>
		    <tr>
		      <td colspan="4" align="center"><iframe src="_list1.htm" name="frame12" id="framelist"  align="MIDDLE" width="920" height="260" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe></td>
		    </tr>
		    <tr>
		      <td valign="bottom" align="center"><table id=dellist  width="920"  height="19" border="0" cellspacing="0" cellpadding="1">
			  <tr>
			  <td width="5"></td>
			  ...
			  <td width="54"  class="style6" ><input type="hidden" name="id"><input type="hidden" name="AllowID"><input type="hidden" name="Allow"></td>
			   <td colspan="1" valign="top" align="right"><input type="button" value="<%write(pps_export);%>" class="input-button" onClick="ExportUser();" id="export">&nbsp;&nbsp;<input type="hidden" name="delstr" size=10 ><input type="button" value="<%write(pps_import);%>" class="input-button" onClick="ImportConfig()" id="export">&nbsp;&nbsp;<input type="button" value="<%write(com_addNew);%>" class="input-button" onClick="EditConfig(0)" id="add">&nbsp;&nbsp;<input type="button" value="<%write(com_delAll);%>" class="input-button" onClick="delAll()" id="delall">&nbsp;&nbsp;<input type="button" value="<%write(com_delete);%>" class="input-button" onClick="delPppoe()" id="del"></td>
			  </tr>
<tr>
    <td colspan="3"></td>
