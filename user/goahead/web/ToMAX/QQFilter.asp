  ...
  <tr valign="top">
	...
	<p>&nbsp;</p>
		...
		var arrayThreeMenu=new Array(
						"95%",
						3,
						new Array("QQ白名单",'QQFilter.asp',1,1),
						new Array("MSN白名单",'MSNFilter.asp',1,0),
...
<tr>
  ...
  <tr>
   <td background="<%write(com_imgdot);%>"><img src="<%write(com_imgspace);%>" width="8" height="1"></td>
		    ...
		    <tr>
		      <td colspan="4" style="background-color:#ffffff;"><iframe src="_list1.htm" name="frame12" id="framelist" align="MIDDLE" width="920" height="260" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe></td>
		    </tr>
		    <tr>
