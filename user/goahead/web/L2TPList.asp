...
{
	if(index==0) dspList(index,list,820,titles1,10,arrayData1,1,1);
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr valign="top">
    <td>
	<p>&nbsp;</p>
   <table id=grouplist class="style7"  width="80%"  border="0" align="center" cellpadding="0" cellspacing="0" height="250" >
   <tr><td colspan="4" height="20">&nbsp;</td></tr>
  <tr >
    <td align="center"  ><form name="L2TPList" method="post" action="/goform/l2tpSrvListDel"><table id=grouplist style="display" width="600"  border="0" align="center" cellpadding="0" cellspacing="0">

		    <tr bgcolor="c0ddff">
		      <td colspan="4"><iframe src="_listhead1.htm" name="frame11" scrolling="no" align="MIDDLE" width="600" height="45" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden ></iframe>
		       </td>
		    </tr>
		    <tr bgcolor="c0ddff">
		      <td colspan="4"><iframe src="_list1.htm" name="frame12" id="framelist" align="MIDDLE" width="600" height="150" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe> <span class="style6">
