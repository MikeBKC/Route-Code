  ...
  <tr>
	...
	<tr><td colspan="4" height="40">&nbsp;</td></tr>
		    ...
		    <tr>
			 ...
			 <td width="45" valign="top" align="right"><input type="submit" value="<% write(com_delete); %>" class="input-button" onClick="return(genData(FixDhcp_List,0,frame12,FixUserNames,'<% write(StaticDHCPMsg); %>'))" id="del"></td>
			  </tr>
		      </table></td>
		    </tr>
		  </table></td></tr></table>
