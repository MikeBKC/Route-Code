#!/bin/bash
#
# RCSID $Id: kernel.patch.gen.sh,v 1.1 2012/09/27 21:08:13 yu.dehai Exp $
...
echo found $i
echo "RCSID \$Id: kernel.patch.gen.sh,v 1.1 2012/09/27 21:08:13 yu.dehai Exp $" >$patchdir/$l
...
# Revision 1.1  2012/09/27 21:08:13  yu.dehai
