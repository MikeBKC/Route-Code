        ...
        <div id="main" >
        	<div id="map" >
				...
				<a href="#" id="set_network" class="ok guide_s"><span><%write(WirelessSet);%></span></a>
	               ...
	               <div id="lans_list">
				   <span id="wan" title="WAN" class="offline"></span>
				   <span id="lan1"  class="offline" style="margin-right: 0;margin-left:136px; margin-top:-27px; width:16px;"></span>
				   <span id="lan2"  class="offline" style="margin-right: 0;margin-left:155px; margin-top:-28px; width:16px;"></span>
				   <span  id="lan3" class="offline"></span>
				   <span  id="lan4" class="offline"></span>
			</div>
                <p id="devices">
