...
#define WIFIDOG_MAKE_MONEY FYES
 ...
 * l2tp client
 */
#define L2TP_CLIENT                     FYES
#define MAX_L2TP_CLIENT_PROFILES        1

/*
 * pptp server
 */
#define PPTP_SERVER			FYES
 ...
 * pptp client
 */
#define PPTP_CLIENT			FYES
//#define PPTP_DBG
#define MAX_PPTP_CLI_PROFILES		1

#if (UTT_SMART_UI == FYES)
#define VPN_PROXY                       FYES
#define VPN_CONTROL                     FYES /*VPN并发控制*/
 ...
 * PPPoE计费
 */
#define PPPOE_ACCOUNT FYES

#define PPPOE_LIMIT FYES
 ...
 *    29 * 远程wifidog认证
 *       30 * */
#define UTT_KNOWIFI FYES
#if (UTT_KNOWIFI == FYES)
#define MAX_KNOWIFI_DOMAIN_COUNT 30
#endif

#define WIFIDOG_AUTH FYES
...
#define UTT_LOGIN_LIMIT FYES
#define APP_POLICY_REMOTE_UPDATE FYES
//IP冲突自动修复
