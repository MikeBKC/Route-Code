...
__be32 utt_collision_detection __read_mostly;
#endif
#ifdef CONFIG_UTT_DHCP_SERVER_DETECTION
__be32 utt_dhcp_server_detection __read_mostly;
#endif
...
#ifdef CONFIG_UTT_DHCP_COLLISION
	{
		.procname	= "utt_collision_detection",
		.data		= &utt_collision_detection,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
...
#ifdef CONFIG_UTT_DHCP_SERVER_DETECTION
	{
		.procname	= "utt_dhcp_server_detection",
		.data		= &utt_dhcp_server_detection,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
