...
utt_exception_group utt_except_group;
...
{
	DBGPRINT(RT_DEBUG_CK, ("---------------Clean exception group-------------\n"));

	memset(utt_except_group.utt_except_sta, 0, sizeof(utt_except_group));
	mod_timer(&my_timer, jiffies + 600 * HZ);

	return;
}

static int my_timer_init()
{
//	printk("++++++++++++++++++++rt2880_ck_timer init++++++++++++++++\n");
	init_timer(&my_timer);
...
static int my_timer_exit()
{
//	printk("--------------------rt2880_ck_timer exit------------------\n");
