...
#define RTPRIV_IOCTL_GET                                                        (SIOCIWFIRSTPRIV + 0x1D)
#endif
...
#define RTPRIV_IOCTL_APCLI_STATUS       (SIOCIWFIRSTPRIV + 0x1B)
#endif	/*end of CONFIG_MT7610_APCLI_CONN_STATUS*/
#ifdef CONFIG_RT_IOCTL_SSID_STA_INFO_GET
#define RTPRIV_IOCTL_SSID_STA_INFO     (SIOCIWFIRSTPRIV + 0x1C)
#endif
/*get wifi channel score*/
#ifdef CONFIG_WIFI_CHANNEL_SCORE
#define RTPRIV_IOCTL_WIFI_SCORE         (SIOCIWFIRSTPRIV + 0x1D)
#endif
