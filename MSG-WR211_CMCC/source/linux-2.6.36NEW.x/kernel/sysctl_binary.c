...
static const struct bin_table bin_net_ipv4_conf_vars_table[] = {
	...
	{ CTL_INT, NET_IPV4_CONF_IF_WAN,		        "if_index" },
        { CTL_INT, NET_IPV4_CONF_BANDWITH_DOWN,          "bandwith_down" },
        { CTL_INT, NET_IPV4_CONF_BANDWITH_UP,            "bandwith_up" },
        { CTL_INT, NET_IPV4_CONF_BANDWITH_DOWN_RATIO,    "bandwith_down_ratio" },
        { CTL_INT, NET_IPV4_CONF_BANDWITH_UP_RATIO,      "bandwith_up_ratio" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_CREDIT,		"bandwith_credit" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_QUEUELEN,		"bandwith_queueL" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_INTERVAL,		"bandwith_interval" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_ENABLE,		"bandwith_enable" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_DELAY,		"bandwith_delay" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_DOWNDROP,		"bandwith_downdrop" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_UPDROP,		"bandwith_updrop" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_SDOWN,		"bandwith_sdown" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_SUP,		"bandwith_sup" },
	{ CTL_INT, NET_IPV4_CONF_BANDWITH_HZ,		"bandwith_hz" },
	{ CTL_INT,	NET_IPV4_CONF_FORWARDING1,		"forwarding1" },
	{}
};
...
#ifdef CONFIG_UTT_SYS_LOG_INFO
	{ CTL_INT,	NET_IPV4_NF_COLLSION_DETECTION,		"utt_collision_detection" },
#endif
#ifdef CONFIG_UTT_DHCP_SERVER_DETECTION
	{ CTL_INT,	NET_IPV4_NF_DHCP_SERVER_DETECTION,	"utt_dhcp_server_detection" },
#endif
...
static const struct bin_table bin_net_netfilter_table[] = {
	...
	{ CTL_INT, NET_NF_UTT_CONNLIMIT_SWITCH,			"utt_connlimit_switch" },
	{ CTL_INT, NET_NF_UTT_CONNLIMIT_MAX,			"utt_host_conn_max" },
	{ CTL_INT, NET_NF_UTT_CONNLIMIT_TCP_MAX,			"utt_host_tcp_conn_max" },
	{ CTL_INT, NET_NF_UTT_CONNLIMIT_UDP_MAX,			"utt_host_udp_conn_max" },
	{ CTL_INT, NET_NF_UTT_CONNLIMIT_ICMP_MAX,		"utt_host_icmp_conn_max" },
#if 0
	{ CTL_INT, NET_NF_UTT_CONN_LAN_IP,			"utt_conn_lan_ip" },
#endif
#endif
	{ CTL_INT, NET_NF_LOCAL_ADDRESS, 			"utt_local_address" },
	{ CTL_INT, NET_NF_LOCAL_IFNAME,				"utt_local_ifname" },
