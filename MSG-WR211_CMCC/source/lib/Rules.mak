...
ifneq ("$(CONFIG_DEFAULTS_RALINK_RT3052)$(CONFIG_DEFAULTS_RALINK_RT3883)$(CONFIG_DEFAULTS_RALINK_RT2880)$(CONFIG_DEFAULTS_RALINK_RT5350)$(CONFIG_DEFAULTS_RALINK_MT7620)$(CONFIG_DEFAULTS_RALINK_MT7621)$(CONFIG_DEFAULTS_RALINK_MT7628)","")
...
CFLAGS:=$(XWARNINGS) $(CPU_CFLAGS) $(SSP_CFLAGS) \
	-fno-builtin -nostdinc -I. -I$(CONFIG_CROSS_COMPILER_PATH)/../powerpc-linux-gnu/libc/usr/include
else
CFLAGS:=$(XWARNINGS) $(CPU_CFLAGS) $(SSP_CFLAGS) \
	-fno-builtin -nostdinc -D_LIBC -I. -I$(CONFIG_CROSS_COMPILER_PATH)/../include
endif
endif
