...
{
	if(index==0) dspList(index,list,600,titles1,8,arrayData1,1,1);
}
/******************list***********************/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr valign="top">
   ...
   <table id=grouplist style="display" width="80%"  border="0" align="center" cellpadding="0" cellspacing="0" height="470">
  <tr>
