...
var AddGroupName=new Array();var userGroupNames=new Array();
		var QQ="";var WLMessenger="";var AliIM="";var Fetion="";var WebQQ="";var Wechat=""; var yahootong="";var BitTorrent="";var Thunder="";var QQLive="";var PPStream=""; var KuGou="";
...
function init(){
	...
	selObject(f,"groupSel");
 	...
 	//	f.yahootong.checked=(yahootong.toLowerCase()=="on"?true:false);	 
		f.Fetion.checked=(Fetion.toLowerCase()=="on"?true:false);	 
		f.Wechat.checked=(Wechat.toLowerCase()=="on"?true:false);
...
<td width="11">&nbsp;</td>
<td width="20" height="25" align="right"><input type="checkbox" name="Wechat" value="170"></td>
<td width="11">&nbsp;</td>
<td width="161">禁止微信</td>
</tr>
<tr>
</tr>
</table></td>
