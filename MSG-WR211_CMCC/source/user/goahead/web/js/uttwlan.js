...
TomatoRefresh.prototype = {
	...
	start: function() {
		...
		//start测试代码
		/************************************************ajax后台读取请注释掉下面的代码*************************************/
//this.http.onCompleted("netdev={'eth2.2':{rx:0x21,tx:0x22},'br0':{rx:0x20,tx:0x30},'eth1':{rx:0x20,tx:0x30},'eth1':{rx:0x20,tx:0x30}}");
/*var testStr="netdev={"
	+"'WAN1':{rx:0x12,tx:0x30},"
	+"'WAN2':{rx:0x12,tx:0x30},"
	+"'WAN3':{rx:0x12,tx:0x30},"
	+"'WAN4':{rx:0x12,tx:0x30},"
	+"'LAN':{rx:0x12,tx:0x30}"
	+"'1':{rx:0x12,tx:0x30},"
	+"'2':{rx:0x22,tx:0x30},"
	+"'3':{rx:0x32,tx:0x30},"
