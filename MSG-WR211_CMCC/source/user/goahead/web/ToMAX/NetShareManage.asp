                            ...
                            <td align="center" class="style7">
                          		<table border="0" width="800" align='center' cellpadding="0" cellspacing="0">
                                    ...
                                    <tr valign="top"><td align="center">
                                    	<table cellpadding="0"  width="800" border="0"  cellpadding="0" cellspacing="1">
                                        	<tr height="22" bgcolor="#AEACAC">
                                            	<td align="center" style="color:#ffffff"><% write(volume); %></td>
                                                <td align="center" style="color:#ffffff"><% write(total); %></td>
                                                <td align="center" style="color:#ffffff"><% write(used); %></td>
                                                <td align="center" style="color:#ffffff"><% write(surplus); %></td>
                                                <td align="center" style="color:#ffffff"><% write(usedvolume); %></td>
                                                <td align="center" style="color:#ffffff"><% write(shareControl); %></td>
                                            </tr>
                                                ...
                                                if(deviceInfos.length!=0){
													for(var i =0;i<deviceInfos.length;i++){
														...
														document.write("<td align='center'>"+deviceInfos[i][0]+"</td><td align='center'>"+deviceInfos[i][1]+"</td><td align='center'>"+deviceInfos[i][2]+"</td><td align='center'>"+deviceInfos[i][3]+"</td><td align='center'>"+deviceInfos[i][4]+"</td><td align='center'><input type='button' class='input-button' value='"+deviceInfos[i][5]+"' onClick='statusChange(this,"+i+")'/></td>");	
														document.write("</tr>");
													}	
												}else{
