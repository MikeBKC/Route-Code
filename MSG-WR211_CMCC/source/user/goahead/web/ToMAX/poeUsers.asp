...
<% langTran("poeUsers"); %>
<% langTran("common"); %>
<title><% write(PPPoEChangePW); %></title>
...
<body>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#6BB23A"><tr>
<td height="551">
...
<tr>
  ...
  <td></td>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="configSubmit"  bgcolor="#A9D1DC" value="<% write(Updata); %>" onClick="save()"><input type="hidden" name="userCommand" id="userCommand" value="userAuth"></td>
</tr>
