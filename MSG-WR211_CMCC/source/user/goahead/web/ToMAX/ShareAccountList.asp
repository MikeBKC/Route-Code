   ...
   <table id=grouplist style="display" width="920"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td colspan="4" height="20">&nbsp;</td></tr>
    ...
    <tr><td colspan="4"><table width="100%"><tr>
	  <td  class="helpfont" height="30" id="discription6" align="left"><strong><% write(attention); %></strong><% write(attentionInfo); %><br> </td>	  
		    ...
		    <tr bgcolor="c0ddff">
		      <td colspan="4"><iframe src="_list1.htm" name="frame12" id="framelist" align="MIDDLE" width="920" height="140" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe></td>
		    </tr>
		    <tr>
