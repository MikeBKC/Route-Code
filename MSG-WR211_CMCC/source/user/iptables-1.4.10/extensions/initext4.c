...
extern void libxt_HTTPCRACK_init(void);
extern void libxt_HTTPPROXY_init(void);
extern void libxt_httpQQ_init(void);
extern void libxt_HTTPREDIRECT_init(void);
...
extern void libxt_TCPMSS_init(void);
extern void libxt_TCPOPTION_init(void);
extern void libxt_TCPOPTSTRIP_init(void);
extern void libxt_TCPWINDOW_init(void);
...
extern void libxt_uttdev_init(void);
extern void libxt_UTTEXCEPTALIIM_init(void);
extern void libxt_UTTEXCEPTMSN_init(void);
extern void libxt_UTTEXCEPTQQ_init(void);
extern void libxt_UTTHOSTSTA_init(void);
extern void libxt_UTTINDENTIFY_init(void);
extern void libxt_UTTLOG_init(void);
extern void libxt_UTTNETSNIPER_init(void);
extern void libxt_UTTPOLICY_init(void);
extern void libxt_uttsniper_init(void);
extern void libxt_UTTWEBIND_init(void);
extern void libxt_wifiMatch_init(void);
...
extern void libipt_domain_init(void);
extern void libipt_ecn_init(void);
extern void libipt_ECN_init(void);
extern void libipt_icmp_init(void);
extern void libipt_IPCRACK_init(void);
...
extern void libipt_WIFIREJECT_init(void);
...
void init_extensions(void)
{
 ...
 libxt_helper_init();
 libxt_HTTPCRACK_init();
 libxt_HTTPPROXY_init();
 libxt_httpQQ_init();
 libxt_HTTPREDIRECT_init();
 ...
 libxt_tcpmss_init();
 libxt_TCPMSS_init();
 libxt_TCPOPTION_init();
 libxt_TCPOPTSTRIP_init();
 libxt_TCPWINDOW_init();
 libxt_TEE_init();
 libxt_time_init();
 libxt_tos_init();
 libxt_TOS_init();
 ...
 libxt_udp_init();
 libxt_uttdev_init();
 libxt_UTTEXCEPTALIIM_init();
 libxt_UTTEXCEPTMSN_init();
 libxt_UTTEXCEPTQQ_init();
 libxt_UTTHOSTSTA_init();
 libxt_UTTINDENTIFY_init();
 libxt_UTTLOG_init();
 libxt_UTTNETSNIPER_init();
 libxt_UTTPOLICY_init();
 libxt_uttsniper_init();
 libxt_UTTWEBIND_init();
 libxt_wifiMatch_init();
