...
/* $Id: centralserver.h,v 1.2 2014/12/22 11:35:05 li.wenchang Exp $ */
...
#define REQUEST_TYPE_WECHAT_ATTENTION "wechatAttention"
#define REQUEST_TYPE_MAC_VALIDATE "macValidate"
