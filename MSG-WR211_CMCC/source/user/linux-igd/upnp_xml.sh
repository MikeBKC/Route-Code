...
brandName=`uttcli get_brandName`
brandHttp=`uttcli get_brandHttp`
brandNameC=`uttcli get_brandNameC`
brandDescriptions=`uttcli get_brandDescriptions`
if [ ! -e "/etc/linuxigd" ]; then
    mkdir /etc/linuxigd
fi
cp /etc/linuxigd/ligd.gif /etc/linuxigd
if [ ! -n "$1" ]; then
...
<root xmlns=\"urn:schemas-upnp-org:device-1-0\">
        ...
        <device>
                ...
                <friendlyName>$brandName Internet Gateway Device</friendlyName>
                <manufacturer>$brandName UPnP IGD Project</manufacturer>
                <manufacturerURL>$brandHttp</manufacturerURL>
                <modelDescription>$brandDescriptions</modelDescription>
                <modelName>$brandName IGD Version 1.00</modelName>
                <modelNumber>$brandNameC</modelNumber>
