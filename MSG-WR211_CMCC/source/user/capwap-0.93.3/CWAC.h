...
typedef struct _wlInfo_t {
    unsigned char WTPMac[MAC_ADDR_LEN];
}wlInfo_t;
...
extern CWBool CWACParseUrcpPDURequest(int wtpIdx, unsigned char *buff, int len);
#endif
#endif
