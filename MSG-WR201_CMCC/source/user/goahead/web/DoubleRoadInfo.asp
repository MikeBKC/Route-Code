...
{
	if(index==0) dspList(index,list,720,titles1,9,arrayData1,0,1);
}
/******************list***********************/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<tr><td colspan="4" height="40">&nbsp;</td></tr>
		    ...
		    <tr bgcolor="c0ddff">
		      <td colspan="4"><iframe src="_list1.htm" name="frame12" id="framelist" align="MIDDLE" width="600" height="145" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe></td>
		    </tr>
		    <tr>
