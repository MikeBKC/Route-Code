...
{
	if(index==0) dspList(index,list,920,titles1,12,arrayData1,1,1);
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr valign="top">
    <td>
	<p>&nbsp;</p>
   <table id=grouplist width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" height="250" >
  <tr >
    <td align="center" class="style7" ><form name="PPTPClientList" method="post" action="/goform/pptpListDel"><table id=grouplist style="display" width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
		    ...
		    <tr>
		      <td colspan="4" align="center"><iframe src="_listhead1.htm" name="frame11" scrolling="no" align="MIDDLE" width="920" height="45" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden ></iframe>
		       </td>
		    </tr>
		    <tr>
		      <td colspan="4" align="center"><iframe src="_list1.htm" name="frame12" id="framelist" align="MIDDLE" width="920" height="260" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe> <span class="style6">
