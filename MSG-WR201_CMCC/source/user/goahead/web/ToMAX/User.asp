...
{
	if(index==0) dspList(index,list,920,titles1,1,arrayData1,1,1);
}
/******************list***********************/
...
<tr>
   ...
   <table id=grouplist style="display" width="70%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td colspan="4" height="20">&nbsp;</td></tr>
		    ...
		    <tr>
		      <td colspan="4" align="center"><iframe src="_list1.htm" name="frame12" id="framelist" align="MIDDLE" width="920" height="140" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe></td>
		    </tr>
		    <tr>
