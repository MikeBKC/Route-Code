...
{
	if(index==0) dspList(index,list,920,titles1,4,arrayData1,0,0);
}
/******************list***********************/
function SaveUserAllow(index,i)
{
	...
	{
		if(str=="<% write(Filter); %>") WlanHostInfo_List.action ="/goform/ConfigWlanMacFilter_5g";
		else  WlanHostInfo_List.action ="/goform/ConfigWlanMacFilterDel_5g";
...
function FilterAll(){
	WlanHostInfo_List.action="/goform/ConfigAddAllMAC_5g";//HostListAddAll
	WlanHostInfo_List.submit();
}
function clearInfo(){
	WlanHostInfo_List.action="/goform/ConfigHostListClear_5g";
	WlanHostInfo_List.submit();
}
//-->
</script>
   ...
   <table id=grouplist style="display" width="80%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td colspan="4" height="20">&nbsp;</td></tr>
    <tr><td colspan="4"><table width="100%"><tr>
	  ...
	  <strong><% write(ShowMsg1); %></strong><% write(ShowMsg2); %><br></td>	  
		    ...
		    <tr>
		      <td colspan="4"><iframe src="_list1.htm" name="frame12" id="framelist" align="MIDDLE" width="920" height="485" marginwidth="1" marginheight="1" frameborder="0" overflow-y:hidden></iframe></td>
		    </tr>
		    <tr>
			  ...
			  <td  class="style6"><div align="left">
				<input type="hidden" name="pages" value="WlanHostInfo_5g.asp"></div></td>
