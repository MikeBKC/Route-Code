          ...
          <script language="javascript">
                 var arrayThreeMenu=new Array(
	                                                    "80%",
														 ...
														 new Array("AP用户统计",'firstPage.asp',1,1),
														 new Array("SSID用户统计",'firstWlanSSIDClts.asp',1,0),
...
<tr>
  ...
  <tr>
    <td>
        <form name="WlanApClientsStatistics" method="post" action="">
            <table id=grouplist style="display"  border="0" align="center" cellpadding="0" cellspacing="0"><!--表单1里面的表格-->
		<tr><td colspan="4" height="20">&nbsp;</td></tr>   
		<tr>
		      <td colspan="4">
			  <table width="100%" height="20" border="0" cellpadding="0" cellspacing="0"><!--1-->
				 	<tr>
						<td>
							<table width="100%" height="20" border="0" cellspacing="0" cellpadding="0" bgcolor=""><!--2-->
								<tr>
									<td width="226" background="images/tablehead.gif" style="background-repeat:no-repe
     at"><img src="images/space.gif" width="10" height="8"></img><span class="style4">AP用户统计</span></td>
			                        <td   width="324"align="right"  class="style5" ><img src="images/space.gif" width=
     "10" height="8"></td><td width="50" align="right"><span id="strRecsGroup"></span></td>
			                     </tr>
							</table><!--2-->
						</td>
					</tr>
					<tr class="style18">
					    <td height="24" colspan="4"  ><table width="600"  border="0" cellspacing="0" cellpadding="0"><!--3-->
							<tr>
							   <td width="10"><img src="images/space.gif" width="10" height="8"></td>
			                   <td width="25" valign="bottom" class="style6"><span id="strGroup"></span></td>
							   <td class="style6" valign="bottom">每页显示AP数
							   <select id="apPerGroup" name="apPerGroup" onChange="dynamicShowGroup(this)" style="width:50px;height:18px;">
							   <option value="10" selected="selected">10</option>
							   <option value="20">20</option>
							   </select></td>
							   <td width="40" valign="bottom"><a href="javascript:;" onClick="firstgroup()" class="ablacks">第一组</a></td>
							   <td width="40" valign="bottom"><a href="javascript:;" onClick="pregroup()"  class="ablacks">上一组</a></td>
							   <td width="40" valign="bottom"><a href="javascript:;" onClick="nextgroup()" class="ablacks">下一组</a></td>
							   <td width="40" valign="bottom"><a href="javascript:;" onClick="lastgroup()"  class="ablacks">最后组</a></td>
							   <td width="30" valign="bottom"><a href="javascript:;" onClick="goanothergroup()" class="ablacks">前往</a></td>
							   <td width="15" valign="bottom"><span class="style6">第</span></td>
							   <td width="10" valign="bottom" class="style6"><input name="groupnumber" id="groupnumber" type="text" class="input" onKeyPress="gotogroup(event)"  size="1" maxlength="3"></td>
							   <td width="10" valign="bottom" class="style6">&nbsp;&nbsp;组</td>
							   <td width="25" valign="bottom" class="style6">&nbsp;</td>
							   <td width="35" valign="bottom"><span class="style6">搜索</span></td>
							   <td width="55 " valign="bottom" class="style6"><input name="txtSearch" id="txtSearch" type="text" class="input" onKeyPress="searchDataEx(event)"  size="1" maxlength="60"  style="width:100px"></td>
		...
		<tr>
		      <td align="left" valign="center" colspan="4" height="350">
                       <div id="container1" style="width:550px;height:300px; float:left;"></div>
