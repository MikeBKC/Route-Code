          ...
          <script language="javascript">
                 var arrayThreeMenu=new Array(
	                                                   "80%",
														 ...
														 new Array("历史用户统计",'firstWlanHistoryClts.asp',1,1),
...
<tr>
  ...
  <tr>
    <td>
        <form name="HistoryClientsStatistics" method="post" action="">
            <table id=grouplist style="display"  border="0" align="center" cellpadding="0" cellspacing="0"><!--表单3里面的表格-->
		<tr><td colspan="4" height="20">&nbsp;</td></tr>
		<tr>
                      <td colspan="4" width="600" height="20" background="../<% write(com_imgtablehead); %>" style="background-repeat:no-repeat"><img src="../<% write(com_imgspace); %>" width="10" height="8"><span align="center" valign="middle" class="style4">历史用户统计</span></td>
		 </tr>
	        
         	 <tr>
		      <td colspan="4" width="600" height="20" bgcolor="#efefef">
			<table  border="0" width="100%" align="center" cellpadding="0" cellspacing="0" >
			    <tr>
				<td  align="center" valign="center" style="width:80px" >  统计时间：</td>
				<td  align="left" valign="center">
				<select name="statisticsDate" id="statisticsDate" class="input" style="width:90px" onChange="changeDate(this)">
				</select>
				</td>
				<td width="230"></td>
				<td align="right" valign="center" style="width:80px" >当前时间：</td>
				<!--<td align="right" valign="center"><input type="text" name="showNowTime" readonly="true" style="width:120px"/></td>-->
                <td align="left" valign="center"><span id="showNowTime"></span>
			    </tr>
			</table
		...
		<tr>
		      <td align="left" valign="center" colspan="4" height="350">
                       ...
                       <div id="container3" style="width:550px;height:300px; float:left;"></div>
