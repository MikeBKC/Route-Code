...
function dsplist(index,list) {
    if(index==0) dspList(index,list,920,titles1,titles1.length,arrayData1,1,1,0);
}
...
<tr>
<td align="center" class="style7" valign="top"><table id=grouplist style="display" width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
