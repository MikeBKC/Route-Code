...
int update_lns_deafult(char *config_file)
{
    FILE *f=NULL;
    int returnedValue;
    if(config_file != NULL) {
...
void initDefLns(struct lns *defaultlns)
{
    if(defaultlns != NULL) {
    defaultlns->next = NULL;
    defaultlns->exclusive = 0;
    defaultlns->localaddr = 0;
    defaultlns->tun_rws = DEFAULT_RWS_SIZE;
    defaultlns->call_rws = DEFAULT_RWS_SIZE;
    defaultlns->rxspeed = DEFAULT_RX_BPS;
    defaultlns->txspeed = DEFAULT_TX_BPS;
    defaultlns->hbit = 0;
    defaultlns->lbit = 0;
    defaultlns->authpeer = 0;
    defaultlns->authself = -1;
    defaultlns->authname[0] = 0;
    defaultlns->peername[0] = 0;
    defaultlns->hostname[0] = 0;
    defaultlns->entname[0] = 0;
    //defaultlns->range = NULL;
    defaultlns->assign_ip = 1;                /* default to 'yes' */
    //defaultlns->lacs = NULL;
    defaultlns->passwdauth = 0;
    defaultlns->pap_require = 0;
    defaultlns->pap_refuse = 0;
    defaultlns->chap_require = 0;
    defaultlns->chap_refuse = 0;
    defaultlns->idle = 0;
    defaultlns->pridns = 0;
    defaultlns->secdns = 0;
    defaultlns->priwins = 0;
    defaultlns->secwins = 0;
    defaultlns->proxyarp = 0;
    defaultlns->proxyauth = 0;
    defaultlns->challenge = 0;
    defaultlns->debug = 0;
    defaultlns->pppoptfile[0] = 0;
    //defaultlns->t = NULL;
    }
    return ;
...
l2tp_log (LOG_DEBUG, "%s-%d: word =%s value =%s\n", __func__,__LINE__,word,value);
