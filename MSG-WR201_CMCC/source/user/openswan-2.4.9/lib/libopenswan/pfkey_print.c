 ...
 * for more details.
 *
 * RCSID $Id: pfkey_print.c,v 1.1.1.1 2011/08/17 11:10:49 brwang Exp $
 */

char pfkey_v2_print_c_version[] = "$Id: pfkey_print.c,v 1.1.1.1 2011/08/17 11:10:49 brwang Exp $";
