...
/* $Id: auth.h,v 1.7 2015/01/22 10:25:42 han.weiwei Exp $ */
/** @file auth.h
...
typedef struct _t_authresponse {
    ...
    /*带宽控制*/
    int upRate;			/*带宽控制 上行速率 单位: Kbit/s*/
    int downRate;		/*带宽控制 下行速率 单位: Kbit/s*/
#endif
} t_authresponse;
...
#if (SMS_ENABLE == 1)
int authserver_smsOperate(char *phone, int operate, char *result);
#endif
