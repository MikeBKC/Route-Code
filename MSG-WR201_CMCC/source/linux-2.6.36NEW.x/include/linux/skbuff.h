...
/*
 * utt识别类型
 * priFlag: 大类。目前包括聊天、P2P、股票、视频、游戏、购物、社交、网页游戏、
 * 邮件、论坛、其他等 11类。最多256。
 * secFlag: 小类。每一大类中的具体小类，根据策略库中配置读取，相当于ReOS中的pdbIndex。
 * uttIdFlag:utt相关的一些策略标签
 */
typedef struct utt_id_app {
    unsigned char priFlag;
    unsigned int  secFlag;
    UttIdentify uttIdFlag;
} UttApp;
#endif
...
struct sk_buff {
	...
	int			utt_iif;
	__u32			old_ip;
        struct smart_hash_node  *qosHash;
...
#if 1
        struct nf_conn          *utt_ct;
	__u32			utt_mroute_mark;
	__u32			utt_oifindex;
#endif
#if defined(CONFIG_NETFILTER_XT_TARGET_UTTINDENTIFY) || defined(CONFIG_NETFILTER_XT_TARGET_UTTWEBIND)
	UttApp	    utt_app;
...
#define isSkbComeFromLan(skb) ((skb)->utt_iif==0)
