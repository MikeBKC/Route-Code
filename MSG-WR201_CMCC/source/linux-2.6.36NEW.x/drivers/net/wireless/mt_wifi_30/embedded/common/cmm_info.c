...
#define	LINE_LEN	(4+33+20+23+9+7+7+3+10)	/* Channel+SSID+Bssid+Security+Signal+WiressMode+ExtCh+NetworkType*/
...
//	TotalLen = sizeof(CHAR)*((MAX_LEN_OF_BSS_TABLE)*max_len) + 100;
	TotalLen = sizeof(CHAR)*((MAX_LEN_OF_BSS_TABLE)*max_len) + 100 + 10;
...
#endif /* AIRPLAY_SUPPORT */
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("=====>alloc1\n"));

	os_alloc_mem(NULL, (PUCHAR *)&msg, TotalLen);
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("=====>alloc2\n"));
