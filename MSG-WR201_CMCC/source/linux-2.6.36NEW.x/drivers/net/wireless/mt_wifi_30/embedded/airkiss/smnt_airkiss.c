...
INT ak_init(RTMP_ADAPTER *pAd, char *crypt_key)
{
    ...
    airkiss_crypt_key[0]= 0x33;
    airkiss_crypt_key[8]= 0x39;
    airkiss_crypt_key[9]= 0x61;
    airkiss_crypt_key[16]= '\0';
    //static BOOLEAN ak_ch_timerInit = FALSE;
    ret = airkiss_init(&g_ak_contex,&g_ak_conf);
    airkiss_crypt_key[3]= 0x56;
    airkiss_crypt_key[4]= 0x38;
    airkiss_crypt_key[5]= 0x42;
    airkiss_crypt_key[1]= 0x53;
    airkiss_crypt_key[2]= 0x65;
    airkiss_crypt_key[6]= 0x31;
    airkiss_crypt_key[7]= 0x6b;
    ...
    uttAkOutTime = 0u;
#endif
    airkiss_crypt_key[10]= 0x6c;
    airkiss_crypt_key[11]= 0x33;
    airkiss_crypt_key[12]= 0x30;
    airkiss_crypt_key[13]= 0x4c;
    airkiss_crypt_key[14]= 0x70;
    airkiss_crypt_key[15]= 0x78;
