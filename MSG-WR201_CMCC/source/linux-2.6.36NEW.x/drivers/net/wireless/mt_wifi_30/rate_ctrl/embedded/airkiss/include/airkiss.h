...
/* 尝试了airkiss带有aes加密的库
 * 发现会产生段错误
 * 故使用不带aes加密的libairkiss库
 * 而在收到加密的无线密码后，utt自行解密
 * bhou 2016_03_05*/
#define AIRKISS_CRYPT_UTT 1
#ifdef AIRKISS_CRYPT_UTT
#undef AIRKISS_ENABLE_CRYPT
#define UTT_MAX_WIFIPWD_LEN 128 /*WPSPSK的密码长度是8-63，这里只是为了扩展需要*/
#endif
