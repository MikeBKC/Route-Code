...
#define MAX_INI_BUFFER_SIZE		6144
...
#define RT_VLAN_8023_HEADER_COPY(__pAd, __VLAN_VID, __VLAN_Priority, __BYPASS,		\
								__pHeader8023, __HdrLen, __pData,			\
								__FromWhichBSSID, __TPID)					\
{																			\
	VLAN_8023_Header_Copy(__VLAN_VID, __VLAN_Priority, __BYPASS,					\
								__pHeader8023, __HdrLen, __pData,			\
								__FromWhichBSSID, __TPID);					\
}
#else
...
#define RT_VLAN_PKT_DUPLICATE(__pPacket, __pAd, __VLAN_VID, __VLAN_Priority,\
								__BYPASS, __pHeader8023, __HdrLen, __pData,			\
...
#define RT_80211_TO_8023_PACKET(__pAd, __VLAN_VID, __VLAN_Priority,			\
								__BYPASS, __pRxBlk, __pHeader802_3,					\
								__FromWhichBSSID, __TPID)					\
{																			\
	wlan_802_11_to_802_3_packet(											\
				get_netdev_from_bssid(__pAd, __FromWhichBSSID),				\
				__pRxBlk->OpMode,												\
				__VLAN_VID, __VLAN_Priority, __BYPASS,								\
