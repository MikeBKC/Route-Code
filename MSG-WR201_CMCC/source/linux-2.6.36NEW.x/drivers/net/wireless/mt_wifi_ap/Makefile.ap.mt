...
# FTM
#ifeq ($(CONFIG_MT7628_FTM_SUPPORT),y)
...
# RR
ifeq ($(CONFIG_MT7628_DOT11K_RRM_SUPPORT),y)
...
ifeq ($(CONFIG_MT7628_APCLI_SUPPORT),y)
    ...
    ifeq ($(CONFIG_MT7628_APCLI_AUTO_BW_SUPPORT),y) 		
	EXTRA_CFLAGS += -DAPCLI_AUTO_BW_SUPPORT
	ap_objs += $(SRC_DIR)/ap/apcli_autobw.o
    endif	

    ifeq ($(CONFIG_MT7628_APCLI_CERT_SUPPORT),y) 		
...
ifeq ($(CONFIG_MT7628_TXRX_HOOK),y)
