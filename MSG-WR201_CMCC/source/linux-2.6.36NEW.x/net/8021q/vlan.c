...
#ifdef CONFIG_UTT_WX100
extern unsigned int utt_machine_sn;
#endif
static int register_vlan_device(struct net_device *real_dev, u16 vlan_id)
{
	...
	vlan_dev_info(new_dev)->flags = VLAN_FLAG_REORDER_HDR;
        if(vlan_id > 1) {
            ...
            new_dev->dev_addr[1] = 0x22;
            new_dev->dev_addr[2] = 0xaa;
            new_dev->dev_addr[3] = 0xFF & (sn >> 16);
            new_dev->dev_addr[4] = 0xFF & (sn >> 8);
            new_dev->dev_addr[5] = 0xFF & sn;
        }
